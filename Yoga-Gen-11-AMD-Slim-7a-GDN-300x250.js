...
lib.ssMetadata = [
		{name:"Yoga_Gen_11_AMD_Slim_7a_GDN_300x250_atlas_1", frames: [[604,0,50,50],[0,0,300,250],[0,252,300,250],[0,504,300,250],[0,756,300,250],[302,0,300,250],[302,252,300,250],[302,504,300,250],[302,756,300,250]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Yoga_Gen_11_AMD_Slim_7a_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.YogaGen11AMDSlim7aGDN300x250 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(420).to({_off:false},0).to({x:10.35,y:11},12).wait(18));
...
// library properties:
lib.properties = {
	id: '31ECDA1958671D48AF2CA1FBFC3535EA',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Yoga_Gen_11_AMD_Slim_7a_GDN_300x250_atlas_1.png", id:"Yoga_Gen_11_AMD_Slim_7a_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['31ECDA1958671D48AF2CA1FBFC3535EA'] = {
